...
function parseStoreMeta(value) {
  ...
  if (!text.startsWith(STORE_META_PREFIX)) return { descricao: text, horarios_custom: {} };
  try {
    ...
    return { descricao: '', horarios_custom: {} };
  }
}

export function storeMetaDescription({ descricao, horarios_custom } = {}) {
